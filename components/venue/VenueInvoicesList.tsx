...
// already applied to the list above, not a separate query.
function downloadInvoicesCSV(invoices: VenueInvoiceView[], range: RangeValue) {
  const header = "Artist,Package,Payment Type,Event Date,Amount,Status,Invoice Date";
  const rows = invoices.map((i) =>
    [
      csvField(i.artist_name),
