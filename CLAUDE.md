...
## Commands                                                                                                                                                       
  ...
  - GEOAPIFY_API_KEY — venue discovery (Places search) and server-side geocoding. Free tier, no billing required. (GOOGLE_PLACES_API_KEY is no longer used — the Google Cloud project's free trial expired and switching back would require adding a payment method.)
