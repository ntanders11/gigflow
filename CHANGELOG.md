...
- [Fix] Discover Venues search was pulling in irrelevant results (art museums, a bowling alley, a climbing gym, a movie theater) because of an overly broad search category. Narrowed it to specifically target concert halls and performance venues instead — real music venues (e.g. Shank Hall, Lake Park Summer Stage in Milwaukee) now show up without the junk.
